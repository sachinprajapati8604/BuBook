...
$paper_id=$_GET['paper_id'];
      ...
      $paper_detail = $_POST['detail'];
      $paper_link1 = $_POST['link1'];
      $paper_link2 = $_POST['link2'];
      $paper_title=mysqli_real_escape_string($conn,$paper_title);
      $paper_detail=mysqli_real_escape_string($conn,$paper_detail);
      ...
      swal({
        ...
        window.location = "view_paper.php";
    }); </script>';
...
$paper_id=$_GET['paper_id'];
$sql = "SELECT * FROM `cse_papers` where paper_id='$paper_id'";
...
while ($row = mysqli_fetch_assoc($result)) {
 ...
 <h2 class="text-center h1-heading">UPDATE BOOKS</h2>
   <form action="" method="post" enctype="multipart/form-data">
     <p class="mb-3 font-weight-normal text-center p-heading">Upload papers here </p>
     <hr>
 ...
 <small>Book uploaded for <b>'.$paper_sem.'</b> semester.</small>
     </div>
     <div class="form-group">
       <label for="title"> Book Title<sup class="font-weight-bold" style="color: red;">*</sup></label>
       <input value="'.$paper_name.'" type="text" class="form-control" id="title" name="title" aria-describedby="title" required />
   ...
   <textarea class="form-control" name="detail" id="exampleFormControlTextarea1" rows="3">'.$paper_desc.'</textarea>
 </div>
     <div class="form-group ">   
         <label for="price">Google drive link<sup class="font-weight-bold" style="color: red;">*</sup></label>
         <input value="'.$paper_link.'" type="text" class="form-control" id="price" name="link1" required />
       </div>
       <div class="form-group ">
         <label for="bidprice">Google drive Link  for easy note (optional)</label>
         <input value="'.$paper_notes_link.'" type="text" class="form-control" id="bidprice" name="link2" aria-describedby="title"  />
     ...
     <h5>Upload Book Image</h5>
       ...
       <small>Image saved as  '.$paper_img.' </small>
     </div>
