...
<?php include 'basic/navbar.php'; ?>
  ...
  if (count($_FILES) > 0) {
    ...
    if (is_uploaded_file($_FILES['userImage']['tmp_name'])) {
      ...
      $sql="INSERT INTO `cse_papers`( `paper_sem`, `paper_name`, `paper_desc`, `paper_link`, `paper_notes_link`, `paper_img`, `created`) VALUES ('$paper_sem','$paper_title','$paper_detail','$paper_link1','$paper_link2','{$filename}',current_timestamp())";
...
<div class="container my-4 border shadow-sm" style="max-width: 800px;">
  <h2 class="text-center h1-heading">Upload Books</h2>
    ...
    <textarea class="form-control" name="detail" id="exampleFormControlTextarea1" rows="3"></textarea>
      ...
      <div class="form-group ">   
          ...
          <input type="text" class="form-control" id="price" name="link1" required />
        </div>
        <div class="form-group ">
          <label for="bidprice">Google drive Link  for easy note (optional)</label>
          <input type="text" class="form-control" id="bidprice" name="link2" aria-describedby="title"  />
