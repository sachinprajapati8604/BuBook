...
<?php include 'basic/navbar.php'; ?>
  ...
  if (count($_FILES) > 0) {
    ...
    if (is_uploaded_file($_FILES['userImage']['tmp_name'])) {
      ...
      $sql="INSERT INTO `cse_books`( `book_sem`, `book_name`, `book_desc`, `book_link`, `book_notes_link`, `book_img`, `created`) VALUES ('$book_sem','$book_title','$book_detail','$book_link1','$book_link2','{$filename}',current_timestamp())";
